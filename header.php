<div id="mobile-nav" class="hide-menu">
        ...
        <ul>
                ...
                <li class="dropdown">
                    ...
                    <ul class="menuList">
                        ...
                        <li><a href="cuh2gl">Ministry (CUH2GL)</a></li>
...
<nav>
    <div id="logo">
        <a href="https://olanikebejide.org"><img src="./img/logo-black.png" alt=""></a>
    </div>
    <div id="menu">
        <ul>
            <li><a href="about">About</a></li>
    ...
    <div id="orders">
        <a href="shop" id="order-request">Shop</a>
    </div>
    <div  id="mobile-menu">
