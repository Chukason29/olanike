...
<head>
    ...
    <meta name="keywords" content="Career Coaching Olanike Bejide Leadership Development Mentorship">
    ...
    <title>Olanike Bejide | Career Coaching</title>
...
<body>
    ...
    <section id="main-banner">        
        <div id="main-banner-writ">
          <div class="main-banner-writ-left">
              <h1 class="animate__animated animate__flipInX animate__slow"><em>Career Coaching with</em></h1>
              <h3 class="animate__animated animate__flipInX animate__slow">Olanike Bejide</h3>
              <p>
    ...
    <section id="module" style="background-color: rgba(255, 192, 203, .2);">
      <h1 style="color: rgb(51, 0, 51);">Coaching Modules</h1><br><br>
